...
import { WebhookClient, WebhookEvent, IWebhookClientOptions, IWebhookChannelOption, IWebhookRecieverCallback } from './webhook';
 ...
 * ```
 */
export declare function customComponent(service: IServiceInstance, options?: IComponentMiddlewareOptions & {
 ...
 * ```
 */
export declare function webhookReceiver(secret: IWebhookChannelOption, callback: IWebhookRecieverCallback): express.RequestHandler;
